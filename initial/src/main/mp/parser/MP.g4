...
varName: ID;
varList: varName (COMMA varName)* COLON mtype;
mtype: (primType|compType);
...
funcDecl: FUNCTION_KW ID LB paramList? RB COLON mtype SEMICOLON vDecl* body;
procDecl: PROCEDURE_KW ID LB paramList? RB SEMICOLON vDecl* body;
body: BEGIN_KW stmt* END_KW;
...
nonIfStmt:  assignStmt SEMICOLON | withStmt |  forStmt | whileStmt | BREAK_KW SEMICOLON | CONTINUE_KW SEMICOLON | returnStmt SEMICOLON | funcall | body;
...
funcall: invocationExpr SEMICOLON;
